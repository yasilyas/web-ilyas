                ...
                <form class="form-horizontal" name="form" action="sign.php?q=account.php"
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input id="name" name="name" placeholder="Masukan Nama Kamu"
                        ...
                        <div class="form-group">
                            <label class="col-md-12 control-label" for="name"></label>
                            <div class="col-md-12">
                                <input id="college" name="college" placeholder="Masukan Kelas Kalian"
                                    class="form-control input-md" type="text">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input id="mob" name="mob" placeholder="Masukan Nomor HP Kamu"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input id="cpassword" name="cpassword" placeholder="Masukan Lagi Password"
                                    class="form-control input-md" type="password">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <form role="form" method="post" action="admin.php?q=index.php">
                                <div class="form-group">
                                    <input type="text" name="uname" maxlength="20" placeholder="Admin user"
                                        class="form-control" />
                                </div>
                                <div class="form-group">
