        ...
        <nav class="navbar navbar-default title1">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Quiz<b></b></a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        <li <?php if(@$_GET['q']==1) echo'class="active"'; ?>><a href="account.php?q=1"><span
                                    class="glyphicon glyphicon-home" aria-hidden="true"></span>&nbsp;Beranda<span
                        ...
                        <li <?php if(@$_GET['q']==3) echo'class="active"'; ?>><a href="account.php?q=3"><span
                                    class="glyphicon glyphicon-stats" aria-hidden="true"></span>&nbsp;Rangking</a></li>
...
<tr><td><b>No</b></td><td><b>Pelajaran</b></td><td><b>Total Soal</b></td><td><b>Tanda Soal</b></td><td><b>Batas Waktu</b></td><td></td></tr>';
$c=1;
...
<center><h1 class="title" style="color:#00000">Hasil</h1><center><br /><table class="table table-striped title1" style="font-size:20px;font-weight:1000;">';
...
$r=$row['sahi'];
$qa=$row['level'];
echo '<tr style="color:#66CCFF"><td>Total Soal</td><td>'.$qa.'</td></tr>
...
<tr style="color:red"><td><b>No</b></td><td><b>Nama</b></td><td><b>Pertayaan</b></td><td><b>Benar</b></td><td><b>Salah<b></td><td><b>Nilai</b></td>';
$c=0;
while($row=mysqli_fetch_array($q) )
{
$eid=$row['eid'];
...
<table class="table table-striped title1" >
<tr style="color:red"><td><b>Rank</b></td><td><b>Nama</b></td><td><b>Jenis Kelamin</b></td><td><b>Kelas</b></td><td><b>Nilai</b></td></tr>';
$c=0;
while($row=mysqli_fetch_array($q) )
{
$e=$row['email'];
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <img src="image/1.png" width=100 height=100 alt="ilyas" class="img-rounded">
                        </div>
                        <div class="col-md-5">
